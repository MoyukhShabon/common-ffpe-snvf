...
Note:
    ...
    sample_path = "/".join(sample_id.split("_"))
    import os
    os.makedirs(os.path.join(out_dir, sample_path), exist_ok=True)
    
    OUTPUT1 = os.path.join(out_dir, sample_path, f"{sample_id}_corrected_profile.csv")
    OUTPUT2 = os.path.join(out_dir, sample_path, f"{sample_id}_all_solutions.csv")
    plot_bef = os.path.join(out_dir, sample_path, f"{sample_id}_before_correction.pdf")
    plot_aft = os.path.join(out_dir, sample_path, f"{sample_id}_after_correction.pdf")
