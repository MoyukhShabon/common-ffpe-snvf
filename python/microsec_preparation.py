...
def get_neighborhood_sequence(struct_series: pl.Series, fasta_path: str) -> pl.Series:
    """
    Extracts neighborhood sequences using a single fetch per variant for I/O optimization.
    """
...
def get_read_length(bam_path: str, max_reads = 100000) -> int:
...
def make_mut_info(vcf_path: str, ref_fasta_path: str, sample_name: str, simple_repeats_bed: pl.DataFrame | None = None, ct_only: bool = False, snv_only: bool = False) -> pl.DataFrame:
